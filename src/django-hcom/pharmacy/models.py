...
class Scientific_Drug(models.Model):
    ...
    class Meta:
        verbose_name = "Scientific Drug"


class Drug(models.Model):
    drug_name = models.CharField(max_length=255, blank=False)
    drug_dose = models.DecimalField("Dose", max_digits=6, decimal_places=2, default=0)
    drug_unit = models.ForeignKey(Dose_Unit, on_delete=models.CASCADE, default="")
    ...
    company: models.ForeignKey = models.ForeignKey(
        Company, on_delete=models.CASCADE, default=""
    )
...
class Ingredient(models.Model):
    ...
    dose = models.DecimalField("Dose", max_digits=6, decimal_places=2, default=0)
    unit = models.ForeignKey(Dose_Unit, on_delete=models.CASCADE, default="", null=True)
