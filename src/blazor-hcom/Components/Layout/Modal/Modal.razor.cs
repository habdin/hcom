...
public partial class Modal<TEntity> : ComponentBase
{
    ...
    // The Operation and Title parameters are used to
    // properly control the modal's title when it is shown.
    [Parameter] public string? Operation { get; set; }
    [Parameter] public string? Title { get; set; }

    // EventCallback to respond to modal closing events.
    [Parameter] public EventCallback OnClose { get; set; }
    // EventCallback to respond to modal closing when the backdrop is clicked.
