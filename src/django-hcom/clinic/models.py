...
class Patient(models.Model):
    ...
    city: models.ForeignKey = models.ForeignKey(
        City, on_delete=models.CASCADE, default=""
    )
...
class Physician(User):
    speciality: models.ForeignKey = models.ForeignKey(
...
class Clinic(models.Model):
    opening_time: models.TimeField = models.TimeField("Opening time", blank=False)
    closing_time: models.TimeField = models.TimeField("Closing time", blank=False)
    physician: models.ForeignKey = models.ForeignKey(
        Physician, on_delete=models.CASCADE, max_length=50, default="", blank=True
    )
    is_archived: models.BooleanField = models.BooleanField("Inactive", null=False)
...
class Appointment(models.Model):
    appointment_time: models.TimeField = models.TimeField(
        "time", blank=False, default=time
    )
    clinic: models.ForeignKey = models.ForeignKey(
    ...
    appointment_number: models.SmallIntegerField = models.SmallIntegerField(
