...
public partial class Index : ComponentBase, IAsyncDisposable
{
	...
	// Uncomment and rename the Entity for the context App.
	...
	// Modal methods
	// Uncomment and directly use it. Commented since its reference is Entity-dependent.
	...
	private RenderFragment MainForm(string operation) => operation switch
	{
		"create" or "update" => builder =>
		{
			...
			// Uncomment and change the Model Entity class name.
...

	{
		...
		// Uncomment and change the Model Entity Name.
		// builder.AddAttribute(1, "Dummy", Item);
		builder.AddAttribute(2, "Operation", operation);
		builder.CloseComponent();
	}
	...
	// Uncomment and change Model Entity to the context Modal class name.
